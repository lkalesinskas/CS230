...
for k in range(n_folds):
    ...
    np.savetxt("C:\\Users\\Larry\\NilearnStuff\\3D_MRI_NW2_TRAIN_fold_{}.txt".format(k), train_acc)
    np.savetxt("C:\\Users\\Larry\\NilearnStuff\\3D_MRI_NW2_VALIDATION_fold_{}.txt".format(k), val_acc)
